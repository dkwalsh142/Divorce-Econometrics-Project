...
A convincing discussion of what variables to control for is essential. Are your results causal or not? Discuss potential concerns with omitted variables etc along with the consequences of those problems.
 ...
 - The interpretations of our coefficients are as followed. 
    - age_married: A 1 year increase in age at marriage is associated with a decrease divorce in likelihood of .2%
    - children: An increase in 1 child is associated with a decrease in divorce likelihood of 5.9%
    - income: A 1000 dollar increase in age at marriage is associated with a decrease in divorce likelihood of 1.6%
    - educ_primary: A primary school education (compared to no education) is associated with a decrease in divorce likelihood of .2%
    - educ_secondary: A secondary school education (compared to no education) is associated with a decrease in divorce likelihood of 6.6%
    - educ_university: A university education (compared to no education) is associated with a decrease in divorce likelihood of 10.3%
    - male: Being male (compared to female) is associated with a decrease in divorce likelihood of 4.1%
