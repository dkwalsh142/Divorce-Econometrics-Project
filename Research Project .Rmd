...
#It was not possible for our group to find an idenification strategy. All relevant variables were included, they were correctly sampled, as well as being measured correctly. Maritial satsifaction could be a potential omitted variable that would influence the dependent variable, however it is extremely difficult to create a proxy variable for. 
