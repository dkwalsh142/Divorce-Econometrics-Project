...
# Model with reciprocal terms
model_reciprocal <- lm(divorced ~ I(1/age_married) + I(1/income) + I(1/children + 0.001) + employed + educ_primary + educ_secondary + educ_university, data = data)
resettest(model_reciprocal, power = 2:3, type = "fitted")
